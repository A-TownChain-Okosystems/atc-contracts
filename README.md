...
> Smart-Contract-Standards und -Implementierungen - bewusst NICHT im Blockchain-Core (klassische Trennung grosser Oekosysteme).
...
```
ATVM (Execution, in atclang per AD-022)
    v
atc-contracts
    +-- standards/ (ATC-83xx/9000/9900)
    +-- token/ - nft/ - staking/ - governance/
    +-- marketplace/ - bridge/ - launchpad/ - treasury/
    +-- test/
```
