...
for pkg in [
    ...
    "blockchain.contracts.atcoin",
    "blockchain.contracts.atc8300",
    "blockchain.contracts.governance",
    "blockchain.contracts.bridge",
    "blockchain.contracts.atc001",
]:
    _parent(pkg)
...
_register(
    "blockchain.contracts.atc8300.atc8300_token",
    os.path.join("atc8300", "atc8300_token.py"),
)
_register(
    "blockchain.contracts.governance.governance_contract",
    os.path.join("governance", "governance_contract.py"),
)
_register(
    "blockchain.contracts.bridge.bridge_contract",
    os.path.join("bridge", "bridge_contract.py"),
)
_register(
    "blockchain.contracts.atc001.genesis_token",
    os.path.join("contracts", "atc001", "genesis_token.py"),
)
